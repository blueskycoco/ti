...
CONFIG_PARAMETER	g_szDm9ConfigParams[] =
{
	...
	{ CID_IO_BASE_ADDRESS, 0x15000000, NDIS_STRING_CONST("IoAddress")},
	{ CID_DATA_BASE_ADRESS, 0x15000400, NDIS_STRING_CONST("DataAddress")},
	{ CID_IO_RANGE, 0x10, NDIS_STRING_CONST("IoRange")},
	{ CID_IRQ_NUMBER, 0x99, NDIS_STRING_CONST("IrqNumber")},
	{ -1,-1,NULL}
};
...
void	C_DM9000::EDeviceValidateConfigurations(void)
{
	...
	//m_szConfigures[CID_IRQ_SHARED] = FALSE;
...
#define	VALIDATE_ADDR_PORT(p) \
	if(m_uLastAddressPort != (p)) \
		...
		m_szCurrentSettings[SID_ADDR_BASE_ADDRESS] ,  \
	...
	U32		uValue)
{
	...
	NdisRawWritePortUchar(
		m_szCurrentSettings[SID_DATA_BASE_ADDRESS] , 
		(U8)uValue);
	...
	U32		uPort)
{
	...
	NdisRawReadPortUchar(
		m_szCurrentSettings[SID_DATA_BASE_ADDRESS] , &val);
...
{
//	RETAILMSG(0, (TEXT("+C_DM9000::DeviceStart\r\n")));
...
/*		RETAILMSG(0, (TEXT("DM9000 Mac 1: %2x \r\n"),sz[0]));
		RETAILMSG(0, (TEXT("DM9000 Mac 1: %2x \r\n"),sz[1]));
		RETAILMSG(0, (TEXT("DM9000 Mac 1: %2x \r\n"),sz[2]));
		RETAILMSG(0, (TEXT("DM9000 Mac 1: %2x \r\n"),sz[3]));
		RETAILMSG(0, (TEXT("DM9000 Mac 1: %2x \r\n"),sz[4]));
...
/*		RETAILMSG(0, (TEXT("DM9000 Mac : %2x \r\n"),DeviceReadPort(DM9_PAR0)));
		RETAILMSG(0, (TEXT("DM9000 Mac : %2x \r\n"),DeviceReadPort(DM9_PAR1)));
		RETAILMSG(0, (TEXT("DM9000 Mac : %2x \r\n"),DeviceReadPort(DM9_PAR2)));
		RETAILMSG(0, (TEXT("DM9000 Mac : %2x \r\n"),DeviceReadPort(DM9_PAR3)));
		RETAILMSG(0, (TEXT("DM9000 Mac : %2x \r\n"),DeviceReadPort(DM9_PAR4)));
		RETAILMSG(0, (TEXT("DM9000 Mac : %2x \r\n"),DeviceReadPort(DM9_PAR5)));*/
...
//	RETAILMSG(0,(TEXT("C_DM9000::DeviceInterruptEventHandler   NSR = 0x%x\r\n"),nsr));
//	RETAILMSG(0,(TEXT("C_DM9000::DeviceInterruptEventHandler   NSR(Second read) = 0x%x\r\n"), DeviceReadPort(DM9_NSR)));
	...
	PCQUEUE_GEN_HEADER	pObject)
{
	...
	/*
	unsigned int dwTemp;
	volatile unsigned int *pPadCfg = (volatile unsigned int *)0xB60025F0;
	volatile unsigned int *pGpioOE = (volatile unsigned int *)0xB6310034;
	volatile unsigned int *pGpioDIN = (volatile unsigned int *)0xB6310038;
	volatile unsigned int *pGpioLEVEL0 = (volatile unsigned int *)0xB6310040;
	volatile unsigned int *pGpioSt1 = (volatile unsigned int *)0xB6310018;
	volatile unsigned int *pGpioEn1 = (volatile unsigned int *)0xB631001C;
	volatile unsigned int *pGpioSt2 = (volatile unsigned int *)0xB6310028;
...
*/
	...
	/*
	dwTemp = *pPadCfg;
	RETAILMSG(1, (L"PadCfg:0x%08x\r\n", dwTemp));
	dwTemp = *pGpioOE;
	RETAILMSG(1, (L"GpioOE:0x%08x\r\n", dwTemp));
	dwTemp = *pGpioDIN;
	RETAILMSG(1, (L"GioDIN:0x%08x\r\n", dwTemp));
	dwTemp = *pGpioLEVEL0;
	*pGpioLEVEL0 = dwTemp | (1<<25);
	dwTemp = *pGpioLEVEL0;
	RETAILMSG(1, (L"Level0:0x%08x\r\n", dwTemp));
	dwTemp = *pGpioSt1;
	RETAILMSG(1, (L"GioSt1:0x%08x\r\n", dwTemp));
	dwTemp = *pGpioEn1;
	*pGpioEn1 = dwTemp | (1<<25);
	dwTemp = *pGpioEn1;
	RETAILMSG(1, (L"GioEn1:0x%08x\r\n", dwTemp));
	dwTemp = *pGpioSt2;
	RETAILMSG(1, (L"GioSt2:0x%08x\r\n", dwTemp));
	dwTemp = *pGpioEn2;
...
int	C_DM9000::Dm9LookupRxBuffers(void)
{
	...
	for(pdesc=(PDM9_RX_DESCRIPTOR)&desc;;)
	{
		...
		{
			RETAILMSG(1, (TEXT("Queue overflow")));
			BREAK;
			// packet will lost!!
			break;
		}		
