...
{    
	...
	RETAILMSG(1,(TEXT("#wangwj#---------PIN_Init----------------000---\r\n")));
    pPinInitDev = new PININITHANDLE;
    RETAILMSG(1,(TEXT("#wangwj#---------PIN_Init----------------111---\r\n")));
    if ( NULL != pPinInitDev )
    {
        pPinInitDev->pCamDevice = reinterpret_cast<PCAMERADEVICE>( lpvBusContext );
	RETAILMSG(1,(TEXT("#wangwj#---------PIN_Init----------------222---\r\n")));
    ...
    {
    RETAILMSG(1,(TEXT("#wangwj#---------PIN_Init----------------333---\r\n")));
        SetLastError( ERROR_OUTOFMEMORY );
    }
    RETAILMSG(1,(TEXT("#wangwj#---------PIN_Init----------------444---\r\n")));
...
RETAILMSG(1,(TEXT("#wangwj#---------PIN_Deinit-------------------\r\n")));
...
RETAILMSG(1,(TEXT("#wangwj#---------PIN_Open-------------------\r\n")));
    ...
    ) 
{
    ...
    RETAILMSG(1,(TEXT("#wangwj#---------PIN_Close-------------------\r\n")));
