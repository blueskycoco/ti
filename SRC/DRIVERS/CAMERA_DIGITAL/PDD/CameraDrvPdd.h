...
private:
    ...
    void 
    HandleCaptureInterrupt( UINT ulModeTypeIn );

    void 
    HandleStillInterrupt( UINT ulModeTypeIn );
...
private:
	...
	ULONG			m_VideoRes[MAX_SUPPORTED_PINS];
	UCHAR 			m_StillstableFrameCount;//getting stable picture
	UCHAR 			m_CapturestableFrameCount;//getting stable picture
